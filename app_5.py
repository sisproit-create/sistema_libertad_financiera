...
d1 = st.checkbox("Agradecí y revisé mis metas hoy")
d2 = st.checkbox("Leí el marco mental de trading")
d3 = st.checkbox("Acepto que el mercado no me debe nada (solo probabilidades)")
d4 = st.checkbox("No estoy operando para recuperar ni demostrar")
...
s1 = st.checkbox("Mi tipo de trade (Intraday/Swing) está claro")
s2 = st.checkbox("Este trade respeta el timeframe elegido")
s3 = st.checkbox("La invalidación corresponde al tipo de trade (intraday vs swing)")
